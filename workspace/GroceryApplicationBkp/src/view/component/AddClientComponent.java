...
public class AddClientComponent extends JPanel{
	//public AddClientComponent(ClientController clientController) {
		//this.setLayout(new BorderLayout());
		
//		//Label
//		this.add(new JLabel("Add client"), BorderLayout.NORTH);
//		
//		//The inputs
